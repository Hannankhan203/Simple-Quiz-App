const mcqs = [
  ...
  {
    question: "Q4. Which HTML attribute specifies an alternate text for an image?",
    options: [
      "title",
      "src",
      "alt",
  ...
  // },
  // {
  //   question: "Q15. Which CSS property is used to change the font of an element?",
  //   options: [
  //       "font-family",
  //       "font-style",
  //       "font-weight",
  ...
  // },
  // {
  //   question: "Q19. Which property is used to change the left margin of an element?",
  //   options: [
  //       "margin-left",
  //       "padding-left",
  //       "indent",
  ...
  // },
  // {
  //   question: "Q30. Which event occurs when the user clicks on an HTML element?",
  //   options: [
  //       "onmouseclick",
  //       "onchange",
  //       "onclick",
